...
export const metadata: Metadata = {
  title: "AmazonStore - Shop Everything You Need Online",
  description: "Discover millions of products with fast delivery, secure payments, and unbeatable prices. Your one-stop shopping destination with Amazon-style experience.",
  keywords: "online shopping, e-commerce, fast delivery, secure payments, electronics, fashion, home goods",
  metadataBase: new URL("https://amazonstore.com"),
  alternates: {
    canonical: "https://amazonstore.com"
  },
  openGraph: {
    title: "AmazonStore - Shop Everything You Need Online",
    description: "Discover millions of products with fast delivery, secure payments, and unbeatable prices.",
    siteName: "AmazonStore",
    type: "website",
    images: [{
      url: "https://images.pexels.com/photos/5632407/pexels-photo-5632407.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
  ...
  twitter: {
    ...
    title: "AmazonStore - Shop Everything You Need Online",
    description: "Discover millions of products with fast delivery, secure payments, and unbeatable prices.",
    images: ["https://images.pexels.com/photos/5632407/pexels-photo-5632407.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
